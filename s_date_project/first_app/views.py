...
from .forms import RegistrationForm, AccountAuthenticationForm, AccountUpdateForm, HomeForm, UpdateBlogPostForm, CreateBlogPostForm, InvitaionForm
...
def post(request, pk=1):
    ...
    #    try:
        ...
        args = {
            'form': form, 'posts': posts, 'users': users, 'friends': friends,'is_liked': is_liked, 'total_likes': post.total_likes(), 'users_requests':users_requests, 'button_status': button_status,'sent_friend_requests': sent_friend_requests, 'sent_requests':sent_requests, 'rec_friend_requests': rec_friend_requests, 'online_users': online_users
            }
        return render(request, 'first_app/profile_page.html', args)
