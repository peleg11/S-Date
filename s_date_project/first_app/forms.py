...
class RegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = Account
        fields = ('email', 'username', 'password1', 'password2', 'firstname', 'lastname', 'country', 'city', 'birthdate', 'disabillity', 'hobbies', 'profile_pic' )
...
class AccountUpdateForm(forms.ModelForm):
	...
	class Meta:
		model = Account
		fields = ('email', 'username', 'firstname', 'lastname', 'country', 'city', 'birthdate', 'disabillity', 'hobbies', 'profile_pic')
